...
class AWSClient4 {
    /* Name of region, eg. "xx-xxxx-x" in "kinesis.xx-xxxx-x.amazonaws.com". */
    char* awsRegion;
    /* Endpoint, eg. "amazonaws.com" in "kinesis.xx-xxxx-x.amazonaws.com". */
    char* awsEndpoint;
    /* Domain, optional, eg. "A2MBBEONHC9LUG.iot.xx-xxxx-x.amazonaws.com". */
    char* awsDomain;
...
protected:
    ...
    bool httpS;
    /* Name of service, eg. "kinesis" in "kinesis.xx-xxxx-x.amazonaws.com". */
