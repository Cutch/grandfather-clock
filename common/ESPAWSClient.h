...
class ESPAWSClient : public WiFiClientSecure {
    public:
        ESPAWSClient(String service, String key, String secret,
                String region="xx-xxxx-x", String TLD="amazonaws.com"); 
        ...
        AWSResponse doGet(String uri, String queryString="", Task *t=NULL);
        AWSResponse doPost(String uri, String payload, String contentType="application/json", String queryString="", Task *t=NULL);
        AWSResponse send(const String request, Task *t);
    protected:
        String _awsRegion;
        String _awsTLD;
        String _awsService;
